...
var privateKey = fs.readFileSync('/usr/local/nginx/cert/wwww.daboluo.online.key');
var certificate = fs.readFileSync('/usr/local/nginx/cert/www.daboluo.online.pem');
...
httpsServer.listen(3000, function() {
    console.log('HTTPS Server is running on: https://www.daboluo.online:3000');
});
